...
const Module = Class.extend({
	...
	/**
	 * Generates the dom which needs to be displayed. This method is called by the SmartMirror core.
	 ...
	 * This method is called by the SmartMirror core, but only if the user has configured a default header for the module.
	...
	/**
	 * Called by the SmartMirror core when a notification arrives.
...
/**
 * Merging SmartMirror (or other) default/config script by @bugsounet
...
Module.register = function (name, moduleDefinition) {
	if (moduleDefinition.requiresVersion) {
		Log.log(`Check SmartMirror version for module '${name}' - Minimum version:  ${moduleDefinition.requiresVersion} - Current version: ${window.mmVersion}`);
